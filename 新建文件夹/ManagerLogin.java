...
public class ManagerLogin extends JFrame implements  ActionListener{
  ...
  JRadioButton 是,否;//声明单选项对象，性别选择
  ButtonGroup group=null;//声明按钮组
  JButton 录入,查询,删除,修改,显示,返回;//声明相应的操作的按钮
  JPanel p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,pv,ph,pb;//调节布局的通道
  ...
  public ManagerLogin(){       //负责管理员登录的主窗口
      ...
      p4=new JPanel();
      p4.add(new JLabel("学院:",JLabel.CENTER));
      p4.add(学院);
      
      p5=new JPanel();
      p5.add(new JLabel("个人联系方式:",JLabel.CENTER));
      p5.add(个人联系方式);    
      
      p6=new JPanel();
      p6.add(new JLabel("现居住地:",JLabel.CENTER));
      p6.add(现居住地);
      
      p7=new JPanel();
      p7.add(new JLabel("登记日期:",JLabel.CENTER));
      p7.add(登记日期);
      
      p8=new JPanel();
      p8.add(new JLabel("是否发热:",JLabel.CENTER));
      p8.add(是);
      p8.add(否);
     
      p9=new JPanel();
      p9.add(new JLabel("是否在武汉:",JLabel.CENTER));
      p9.add(是);
      p9.add(否);
      
      p10=new JPanel();
      p10.add(new JLabel("是否与患者有亲密接触:",JLabel.CENTER));
      p10.add(是);
      p10.add(否);
     
      p11=new JPanel();
      p11.add(new JLabel("是否返校:",JLabel.CENTER));
      p11.add(是);
      p11.add(否);
      
      pv=new JPanel();//面板
      pv.setLayout(new GridLayout(11,1));   //把pv组件设置成第七行1列的网格布局
